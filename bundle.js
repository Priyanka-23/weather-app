...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(WeatherMain, { location: 'delhi' }), document.getElementById("app"));
	...
	var WeatherMain = React.createClass({
	    ...
	    handleSearch: function handleSearch(location) {
	        ...
	        Api.getTemp(location).then(function (temp) {
	            //then implies everything is fine i.e., if the location is not entered then it wont show any error but tends to jump to another function inside it
	            console.log("1");
	            that.setState({
	                location: location,
	                temp: temp,
	    ...
	    render: function render() {
	        var _state = this.state,
	            ...
	            temp = _state.temp,
	            location = _state.location; //feature of ES6 to enable many no.s of variables to render its state at once
	        ...
	        function renderData() {
	            if (isLoading) {
	                return React.createElement(
	                    ...
	                    null,
	                    'Loading Data...'
	                ); //the msg must be written within a line with return keyword
	            } else if (temp && location) {

	                return React.createElement(WeatherMessage, { temp: temp, location: location }); //the msg must be written in the same line with return keyword
	            }
	        }
	        return React.createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var axios = __webpack_require__(163); //supports promise api's and make http requests
	var WEATHER_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=824ae49e4dbabe4d1faf904ef665a7b8&units=Metric'; // you want to keep your changes unchanged
	module.exports = {
	    getTemp: function getTemp(location) {
	        ...
	        return axios.get(url).then(function (res) {
	            if (res.data.cod && res.data.message) {
	                //cod is the no. of error which is found eg. 404,400,502
